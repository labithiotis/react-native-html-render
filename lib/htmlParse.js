...
export const blockTagArr = ['div', 'section', 'p', 'img', 'address',
    'blockquote', 'dir', 'dl', 'iframe', 'object',
    'form', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6',
    'menu', 'ol', 'pre', 'table', 'ul', 'li', 'hr', 'tbody', 'tr', 'td', 'th']

export const inlineTagArr = ['a', 'abbr', 'b', 'big', 'br', 'cite', 'code', 'em', 'label', 'span', 'strong', 'small', 'font']
...
export const parseHtml = function (html, done) {
